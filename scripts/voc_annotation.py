...
if __name__ == '__main__':
    ...
    # TODO: parser.add_argument("--data_path", default="/home/yang/test/VOC/")
    parser.add_argument("--data_path", default="/home/ubuntu/Documents/Datasets/VOC2012/VOCdevkit/VOC2012")

    parser.add_argument("--train_annotation", default="/home/zhangjiazhao/projects/tensorflow-yolov3-master/data/dataset/voc_train.txt")
    parser.add_argument("--test_annotation",  default="/home/zhangjiazhao/projects/tensorflow-yolov3-master/data/dataset/voc_test.txt")
    ...
    num1 = convert_voc_annotation(flags.data_path, 'trainval', flags.train_annotation, False)
    num2 = 0
