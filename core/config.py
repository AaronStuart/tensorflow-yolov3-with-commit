...
# Set the class name
__C.YOLO.CLASSES                = "./data/classes/logo.names"
...
__C.TRAIN.ANNOT_PATH            = "./data/dataset/logo_train.txt"
...
__C.TRAIN.INITIAL_WEIGHT        = "./checkpoint/yolov3_test_loss=nan.ckpt-20"
...
__C.TEST.ANNOT_PATH             = "./data/dataset/logo_test.txt"
...
__C.TEST.WEIGHT_FILE            = "./checkpoint/yolov3_test_loss=nan.ckpt-18"
