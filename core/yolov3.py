...
class YOLOV3(object):
    """Implement tensoflow yolov3 here
        YOLOV3 predict multi tensor for one input image to detect multi scale object.
        a scale (such as 13 * 13) correspond to a division of image (13 * 13 grid cell), as well as a downsample stride.
        a grid cell correspond to a tensor of shape [anchor_per_scale, 4 + conf + num_class].
    """
    ...
    def decode(self, conv_output, anchors, stride):
        ...
        # create tensor of shape [batch_size, output_size, output_size, anchor_per_scale, 1], init with grid cells' coordinate
    ...
    def bbox_giou(self, boxes1, boxes2):
        ...
        # get left_up corner of inter area
        left_up = tf.maximum(boxes1[..., :2], boxes2[..., :2])
        # get right_down corner of inter area
        right_down = tf.minimum(boxes1[..., 2:], boxes2[..., 2:])

        # inter area exist when (x2 - x1) > 0 and (y2 - y1) > 0
        ...
        # get left_up corner of enclose area
        enclose_left_up = tf.minimum(boxes1[..., :2], boxes2[..., :2])
        # get right_down corner of enclose area
